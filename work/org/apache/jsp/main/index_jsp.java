...
String tree = (String)request.getSession().getAttribute("tree");
      ...
      out.print(path);
      out.write("/main/tree.jsp\" width=\"100%\" height=\"100%\" frameborder=\"0\"></iframe>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id=\"indexTab\" class=\"easyui-tabs\" style=\"width:100%;height:100%\" data-options=\"region:'center',title:''\">\r\n");
      out.write("\t\t\t<div title=\"首页\" style=\"width:100%;height:100%;padding:10px\">\r\n");
      out.write("\t\t\t\t<iframe src=\"");
      out.print(path);
      out.write("/main/main.jsp\" width=\"100%\" height=\"100%\" frameborder=\"0\"></iframe>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</body>\r\n");
      out.write("</html>");
