...
public final class newlogon_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	response.setDateHeader("Expires", 0); //保证每次对页面的访问都是最新的
      ...
      out.write("\t\t\t\t\t\tvar ts = data.getElementsByTagName(\"ts\")[0].firstChild.data;\r\n");
      out.write("\t\t\t\t\t\tvar jg = data.getElementsByTagName(\"jg\")[0].firstChild.data;\r\n");
      out.write("\t\t\t\t\t\tif (jg == \"1\") {\r\n");
      out.write("\t\t\t\t\t\t\tdocument.logonForm.subTransCode.value = \"ent\";\r\n");
      ...
      out.write("\t\t</script>\r\n");
      out.write("\t</head>\r\n");
      out.write("\t<body onload=\"javascript:logonForm.user_code.focus();\" >\r\n");
      ...
      out.write("\t\t\t\t<input type=\"hidden\" name=\"subTransCode\" value=\"ent\">\r\n");
