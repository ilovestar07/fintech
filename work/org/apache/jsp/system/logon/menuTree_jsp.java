...
public final class menuTree_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String tree = (String) request.getSession().getAttribute("tree");
      ...
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"../../images/system/menuIcon.css\">\r\n");
      ...
      out.write("\t\t\t\tif (parent.$('#indexTab').tabs('exists', node.text)) {\r\n");
      out.write("\t\t\t\t\tparent.$('#indexTab').tabs('select', node.text);\r\n");
      out.write("\t\t        } else {\r\n");
      out.write("\t\t        \tvar content = '<iframe frameborder=\"0\"  src=\"'+node.url+'\" style=\"width:100%;height:100%;\"></iframe>';  \r\n");
      out.write("\t\t        \tif ($('#menuTree').tree('isLeaf', node.target)) {\r\n");
      out.write("\t\t\t\t\t\tparent.$('#indexTab').tabs('add', {\r\n");
      ...
      out.write("<body>\r\n");
      out.write("\t<div>\r\n");
      out.write("\t\t<ul id=\"menuTree\" class=\"easyui-tree\"></ul>\r\n");
      out.write("\t</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
